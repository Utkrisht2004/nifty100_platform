...
presets = {
    "Quality Compounder": {'roe': 15.0, 'de': 1.0, 'fcf': 0.0, 'rev_cagr': 10.0, 'pat_cagr': 0.0, 'opm': 0.0, 'pe': 100.0, 'pb': 20.0, 'div': 0.0, 'icr': 0.0},
    "Value Pick":         {'roe': 0.0, 'de': 2.0, 'fcf': -1000.0, 'rev_cagr': 0.0, 'pat_cagr': 0.0, 'opm': 0.0, 'pe': 20.0, 'pb': 3.0, 'div': 1.0, 'icr': 0.0},
    "Growth Accelerator": {'roe': 0.0, 'de': 2.0, 'fcf': -1000.0, 'rev_cagr': 15.0, 'pat_cagr': 20.0, 'opm': 0.0, 'pe': 100.0, 'pb': 20.0, 'div': 0.0, 'icr': 0.0},
    "Dividend Champion":  {'roe': 0.0, 'de': 5.0, 'fcf': 0.0, 'rev_cagr': 0.0, 'pat_cagr': 0.0, 'opm': 0.0, 'pe': 100.0, 'pb': 20.0, 'div': 2.0, 'icr': 0.0},
    "Debt-Free Blue Chip":{'roe': 12.0, 'de': 0.0, 'fcf': -1000.0, 'rev_cagr': 0.0, 'pat_cagr': 0.0, 'opm': 0.0, 'pe': 100.0, 'pb': 20.0, 'div': 0.0, 'icr': 0.0},
    "Reset Filters":      {'roe': -50.0, 'de': 10.0, 'fcf': -50000.0, 'rev_cagr': -50.0, 'pat_cagr': -50.0, 'opm': -50.0, 'pe': 200.0, 'pb': 50.0, 'div': 0.0, 'icr': -10.0}
}
...
clean_df = filtered_df[[c for c in display_cols if c in filtered_df.columns]].sort_values('composite_quality_score', ascending=False)
