...
def run_batch():
    ...
    for ticker in companies:
        ...
        if company_data.empty or company_data.iloc[0]['year_count'] < 3:
            skipped_records.append({'company_id': ticker, 'reason': 'Insufficient historical data (< 3 years)'})
            continue
        ...
        try:
            ...
            skipped_records.append({'company_id': ticker, 'reason': f'Generation Error: {e}'})
    ...
    print(f"[✓] SPRINT 5 EXIT CRITERIA MET. PIPELINE FULLY OPERATIONAL.")
