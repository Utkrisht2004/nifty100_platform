...
def generate_portfolio_summary():
    ...
    header_style = ParagraphStyle(name='CompHeader', fontSize=20, textColor=colors.white, backColor=colors.black, spaceAfter=20, alignment=1, leftIndent=5)
    ...
    print(f"[*] Processing {len(grouped)} companies for the master portfolio summary...")
